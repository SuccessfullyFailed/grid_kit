...
mod test {
	...
	macro_rules! test_grid {
		($type:ty, $grid:expr) => {
			...
			let validation_grid:Grid<$type> = Grid::from_bytes(&bytes).unwrap();
	...
	#[test]
	fn test_grid_byte_conversion_u8() {
		test_int_grid!(u8, 1);
	}

	#[test]
	fn test_grid_byte_conversion_u16() {
		test_int_grid!(u16, 2);
	}

	#[test]
	fn test_grid_byte_conversion_u32() {
		test_int_grid!(u32, 4);
	}

	#[test]
	fn test_grid_byte_conversion_u64() {
		test_int_grid!(u64, 8);
	}

	#[test]
	fn test_grid_byte_conversion_u128() {
		test_int_grid!(u128, 16);
	}

	#[test]
	fn test_grid_byte_conversion_i8() {
		test_int_grid!(i8, 1);
	}

	#[test]
	fn test_grid_byte_conversion_i16() {
		test_int_grid!(i16, 2);
	}

	#[test]
	fn test_grid_byte_conversion_i32() {
		test_int_grid!(i32, 4);
	}

	#[test]
	fn test_grid_byte_conversion_i64() {
		test_int_grid!(i64, 8);
	}

	#[test]
	fn test_grid_byte_conversion_i128() {
	...
	#[test]
	fn test_grid_byte_conversion_f32() {
	...
	#[test]
	fn test_grid_byte_conversion_f64() {
	...
	#[test]
	fn test_grid_byte_conversion_array() {
	...
	#[test]
	fn test_grid_byte_conversion_list() {
		const MAX_SHIFT:usize = 16;
